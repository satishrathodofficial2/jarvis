...
def play_music():
    music_dir = "C:\\Users\\hp\\Downloads\\JARVIS-Voice-Assistant-System-main\\Voice Assisstant\\music"   # <-- change this to your music folder
    try:
...
def gemini_model_response(user_input):
    ...
    prompt = f"Your name is JARVIS, You act like JARVIS. Answer the provided question in short, Question: {user_input}"
...
while True:
    ...
    # Skip processing if no command was recognized
    if query == "none":
        continue
    ...
    # Small talk
        ...
        speak("I was created by Satish sir, a brilliant mind!")
